...
def assign_anchor(feat_shape, gt_boxes, im_info, cfg, feat_stride=16,scales=(8, 16, 32), ratios=(0.5, 1, 2), allowed_border=0):
    """
...
def assign_quadrangle_anchor(feat_shape, gt_boxes, im_info, cfg, feat_strides=[64,32,16,8,4],
